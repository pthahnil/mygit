package com.autho.main.basedao.impl;
...
public class BaseDaoImpl<T>  extends HibernateDaoSupport implements BaseDao<T> {
    ...
    public T getById(int id) {
        return (T) getHibernateTemplate().get(entityClass, id)==null?null:getHibernateTemplate().get(entityClass, id);
    }
    ...
    public int save(T entity) {
        int i = (Integer) getHibernateTemplate().save(entity);
        return i;
    }
	...
	public List<T> getAll() {
		return (List<T>) getHibernateTemplate().find("from "+String.valueOf(entityClass));
	}
}